...
export default function Worker() {
  ...
  function np(i, p) {
    ...
    if (i !== parseInt(i, 10)) throw new Error("np: non int.");
  ...
  function ep(i, p) {
    ...
    if (i !== parseInt(i, 10)) throw new Error("ep: non int.");
  ...
  function rp(i, p) {
    ...
    if (i !== parseInt(i, 10)) throw new Error("rp: non int.");
  ...
  function pass() {
      ...
      for (n = 0; n < W.nodesLength; n += W.ppn) {
        ...
        while (true) {
          if (RegionMatrix[rp(r, "firstChild")] >= 0) {
            ...
            distance = Math.sqrt(
              NodeMatrix[np(n, "x")] -
                RegionMatrix[rp(r, "massCenterX")] ** 2 +
    ...
    coefficient =
      1 *
      (W.settings.outboundAttractionDistribution ? outboundAttCompensation : 1);
  ...
  if (typeof window !== "undefined" && window.document) {
    ...
    sendNewCoords = function sendCoords() {
      let e;
      ...
      requestAnimationFrame(() => document.dispatchEvent(e));
    };
  } else {
    // From a WebWorker
