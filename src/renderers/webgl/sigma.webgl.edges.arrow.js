...
const headPositionLocation = gl.getAttribLocation(program, "a_headPosition");
...
const matrixHalfPiLocation = gl.getUniformLocation(program, "u_matrixHalfPi");
...
const scaleLocation = gl.getUniformLocation(program, "u_scale");
    ...
    initProgram(gl) {
      let vertexShader; let fragmentShader; let program;
