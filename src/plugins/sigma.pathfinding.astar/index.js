export default function extend(sigma) {
  ...
  function defaultPathLengthFunction(node1, node2, previousPathLength) {
    ...
    return (
      ...
      Math.sqrt((node2.y - node1.y) ** 2 + (node2.x - node1.x) ** 2)
    );
  }

  sigma.classes.graph.addMethod("astar", function astar(
    srcId,
    destId,
    settings
  ) {
    ...
    function addToLists(node, previousNode, pathLength, heuristicLength) {
